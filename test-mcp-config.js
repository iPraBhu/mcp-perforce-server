...
/**
 * Test script to verify MCP environment variable configuration
 */

import { P4Config } from './dist/p4/config.js';
...
async function testMcpConfig() {
  ...
  console.log('Config from file:', result1.config);
  ...
  console.log('Environment variables:', setup.env);
  ...
  console.log('\n=== Success! MCP configuration is working ===');
}
